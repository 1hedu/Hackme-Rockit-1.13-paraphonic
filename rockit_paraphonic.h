...
void paraphonic_handle_enable_cc(unsigned char value, g_setting *p_global_setting);  // NEW: CC 103
void paraphonic_handle_ef101d_cc(unsigned char value, g_setting *p_global_setting);  // NEW: CC 104
void paraphonic_handle_subosc_cc(unsigned char value, g_setting *p_global_setting);  // NEW: CC 105
